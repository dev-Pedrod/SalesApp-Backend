...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.devpedrod.cursomc.resources"))
	...
	private ApiInfo apiInfo() {
		 return new ApiInfo("API do curso Spring Boot",
			 ...
			 new Contact("Pedro Oliveira", "https://github.com/dev-Pedrod/Spring-Ionic-project-Backend", "pedroolivxira@gmail.com"),
