...
import com.devpedrod.cursomc.domain.Endereco;
import com.devpedrod.cursomc.domain.Estado;
import com.devpedrod.cursomc.domain.ItemPedido;
import com.devpedrod.cursomc.domain.Pagamento;
import com.devpedrod.cursomc.domain.PagamentoComBoleto;
import com.devpedrod.cursomc.domain.PagamentoComCartao;
import com.devpedrod.cursomc.domain.Pedido;
import com.devpedrod.cursomc.domain.Produto;
import com.devpedrod.cursomc.domain.enums.EstadoPagamento;
import com.devpedrod.cursomc.domain.enums.Perfil;
...
import com.devpedrod.cursomc.repositories.EnderecoRepository;
import com.devpedrod.cursomc.repositories.EstadoRepository;
import com.devpedrod.cursomc.repositories.ItemPedidoRepository;
import com.devpedrod.cursomc.repositories.PagamentoRepository;
import com.devpedrod.cursomc.repositories.PedidoRepository;
import com.devpedrod.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Endereco e3 = new Endereco(null, "Avenida Floriana", "255", null, "Centro", "312377012", cli2, c2);
		
		
		cli1.getTelefones().addAll(Arrays.asList("3185775564","27363323"));
		cli1.getEnderecos().addAll(Arrays.asList(e1, e2));
		cli2.getTelefones().addAll(Arrays.asList("3185895564","27332323"));
